...
import 'package:task_1/Screens/Register/register.dart';
                      ...
                      if (emptyArea == false) {
                        ...
                        try {
                          ...
                          final snackBar = SnackBar(
                            content: Text(UserCredentials.loggedin.toString()),
                          );
                        } catch (e) {
                          print(e);
                        }
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text(
                                "Email is not found or password maybe incorrect please try again")));
                      }
                    }),
///////////////////////////////////////////////////////////////////////////////////
